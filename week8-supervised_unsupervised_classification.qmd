...
```{r include=TRUE}
# Crop the Landsat scene to the extent of the SB county shapefile 
...
# Valid range of pixel values for this collection goes from 7,273 to 43,63
...
SB_classification_dt <- terra::predict(landsat, SB_decision_tree,
                                       type = "class", 
                                       na.rm = TRUE)
...
# Cluster 3 = green vegetation: Large difference between NIR and red band
# Cluster 4 = water: 
# Cluster 1 = soil/dead grass  :higher values across bands 
# Cluster 2 = urban areas: moderate values across bands 
