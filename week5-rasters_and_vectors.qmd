...
# Convert high elevation values into polygons and transform in to a simple feature 
...
bryce = raster(here::here("data", "Bryce_Canyon_GeoTIFF", "Bryce_Canyon.tif"))
...
bryce_small %>% 
  ...
  # Add desert colored lighting at 50% transparency  
...
# Better defines ridges 
  add_shadow(ambient_shade(bryce_small), 0) %>%
  
# Adds texture shading 
...
```{r}
# Define bounding box coordinates for area of interest 
...
# Crop full Bryce raster to area of interest 
...
```{r}
# Creating a combined trails layer with different styles for each type 
